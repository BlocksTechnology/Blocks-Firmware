...
#define CONDITIONALS_POST_H
  ...
  #define ABL_GRID       (ENABLED(AUTO_BED_LEVELING_LINEAR) || ENABLED(AUTO_BED_LEVELING_BILINEAR) || ENABLED(AUTO_BED_LEVELING_TWIN_PROBES))
  #define OLDSCHOOL_ABL  (ABL_PLANAR || ABL_GRID)
  #define HAS_ABL        (OLDSCHOOL_ABL || ENABLED(AUTO_BED_LEVELING_UBL))
  #define HAS_LEVELING   (HAS_ABL || ENABLED(MESH_BED_LEVELING))
  #define HAS_AUTOLEVEL  (HAS_ABL && DISABLED(PROBE_MANUALLY))
  #define HAS_MESH       (ENABLED(AUTO_BED_LEVELING_BILINEAR) || ENABLED(AUTO_BED_LEVELING_UBL) || ENABLED(MESH_BED_LEVELING) || ENABLED(AUTO_BED_LEVELING_TWIN_PROBES))
