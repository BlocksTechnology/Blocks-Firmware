...
//        st_synchronize();       
  ...
  #else
    do_blocking_move_to(10, 20, current_position[Z_AXIS]);
  #endif
  ...
  #else
    do_blocking_move_to(100, 20, current_position[Z_AXIS]);
  #endif
  do_blocking_move_to(current_position[X_AXIS], current_position[Y_AXIS],Z_MIN_POS);
  ...
  #else
    do_blocking_move_to(60, 90, current_position[Z_AXIS]);
  #endif
  do_blocking_move_to(current_position[X_AXIS], current_position[Y_AXIS],Z_MIN_POS);
...
set_pageShowInfo(5);
  ...
  lcd_setstatus("Blocks zero ready");
    }
    break;
