...
#define STRING_CONFIG_H_AUTHOR "(Blocks, PRO S100)" // Who made the changes.
...
#define MAX_BED_POWER 180 //180 anterior // limits duty cycle to bed; 255=full current
  ...
  //Blocks
  #define  DEFAULT_bedKp 156.38
  #define  DEFAULT_bedKi 28.07
  #define  DEFAULT_bedKd 217.79
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 2666.67, 415 } //ALTERADO
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 450, 450, 6, 80 } //5 PARa 3
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_ACCELERATION      { 900, 900, 8, 10000 } //ALTERADO (Z DE 50 PARA 10 PARA 3)
 ...
 */
#define DEFAULT_XJERK                 4.0     //10
#define DEFAULT_YJERK                 4.0     //10  
...
#define X_BED_SIZE 1000    //teste a 400 mas é 1000
#define Y_BED_SIZE 1000    //teste a 400 mas é 1000

// Travel limits (mm) after homing, corresponding to endstop positions.
#define X_MIN_POS 0
#define Y_MIN_POS 0
#define Z_MIN_POS 0
#define X_MAX_POS 1000   //teste a 400 mas é 1000
#define Y_MAX_POS 1000   //teste a 400 mas é 1000
#define Z_MAX_POS 995
...
#define FILAMENT_RUNOUT_SENSOR
  ...
  #define FILAMENT_RUNOUT_SCRIPT "M600 X910 Y40"
#endif
...
//#define DEBUG_LEVELING_FEATURE
...
#if ENABLED(MESH_BED_LEVELING) || ENABLED(AUTO_BED_LEVELING_BILINEAR) || ENABLED(AUTO_BED_LEVELING_UBL) || ENABLED(AUTO_BED_LEVELING_TWIN_PROBES)
  ...
  #define RIGHT_PROBE_BED_POSITION 950     //950
  #define FRONT_PROBE_BED_POSITION 50     
  #define BACK_PROBE_BED_POSITION 950      //950
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT 500     //500   // X point for Z homing when homing all axes (G28).
  #define Z_SAFE_HOMING_Y_POINT 500     //500    // Y point for Z homing when homing all axes (G28).
#endif

// Homing speeds (mm/m)
#define HOMING_FEEDRATE_XY (60*60)
#define HOMING_FEEDRATE_Z  (6*60)  //ALTERADO
 ...
 * Number of servos
 *
 * For some servo-related options NUM_OS will be set automatically.
