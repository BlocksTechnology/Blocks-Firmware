...
#define STRING_CONFIG_H_AUTHOR "(Blocks, zero 1.2.1)" // Who made the changes.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80, 80, 4000,97}  // default steps per unit for Ultimaker
